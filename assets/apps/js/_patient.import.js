$(function () {
    ...
    patient.ajax = {
        get_import_list: function (data, cb) {
        ...
        get_import_hdc: function (s, e,off_id, cb) {
            var url = '/hdc/index',
                params = {
                    s: s,
                    e: e,
    ...
    patient.get_import_list = function () {
        ...
        if (!s) {
            ...
            patient.ajax.get_import_hdc(s, e,off_id, function (err, data) {
                if (err) {
                    app.alert(err);
                }
                else {
                    patient.ajax.get_import_list(data, function (err, data) {
                        if (err) {
                            app.alert(err);
                        }
                        else {
