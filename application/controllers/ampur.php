...
class Ampur extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->prov_code = $this->session->userdata('provid');
        ...
        $this->ampur->hospcode = $this->hospcode;
        $this->ampur->hserv = $this->hserv;
        $this->ampur->amp_code = $this->amp_code;
        $this->ampur->year = $this->year;
    }
