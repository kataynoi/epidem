    ...
    public function do_export()
    {
        ...
        if($this->user_level == '1')
        {
            $sql = '
                ...
                e.name as NAME, e.hn as HN, e.nmepate as NMEPAT, e.sex as SEX, e.agey as AGEY,
                e.agem as AGEM, e.aged as AGED, e.marietal as MARIETAL, n.code506 as RACE, e.race1 as RACE1,
                ...
                e.school as SCHOOL, CONCAT(substr(e.datesick,9,2),'/',substr(e.datesick,6,2),'/',substr(e.datesick,1,4)+543) AS DATESICK,
		        CONCAT(substr(e.datefine,9,2),'/',substr(e.datefine,6,2),'/',substr(e.datefine,1,4)+543) AS DATEDEFINE,
		        CONCAT(substr(e.datedeath,9,2),'/',substr(e.datedeath,6,2),'/',substr(e.datedeath,1,4)+543) AS DATEDEATH,
		        CONCAT(substr(e.daterecord,9,2),'/',substr(e.daterecord,6,2),'/',substr(e.daterecord,1,4)+543) AS DATERECORD,
		        CONCAT(substr(e.datereach,9,2),'/',substr(e.datereach,6,2),'/',substr(e.datereach,1,4)+543) AS DATEREACH, e.intime as INTIME, e.organism as ORGANISM, e.complica as COMPLICA,
                e.cid as IDCARD, e.icd10 as ICD10, e.hserv as OFFICEID

                from epe0 e
                left join ref_nhso_nation n on n.code=e.nation
