    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo site_url('/admin/import_all')?>"><i class="glyphicon glyphicon-th-list"></i> นำเข้าข้อมูลจาก 43 แฟ้มทั้งจังหวัด</a></li>
                    <li><a href="<?php echo site_url('/admin/import2e0')?>"><i class="glyphicon glyphicon-th-list"></i> นำเข้าข้อมูลจาก สู่ E0(ทะเบียนผู้ป่วย)</a></li>
                    <li><a href="<?php echo site_url('/admin/recal_e1')?>"><i class="glyphicon glyphicon-th-list"></i> ประมวลผล E1 ใหม่</a></li>
                    <li><a href="<?php echo site_url('/admin/recal_e0')?>"><i class="glyphicon glyphicon-th-list"></i> ประมวลผล E0 ใหม่</a></li>
                    <li><a href="<?php echo site_url('/admin/member')?>"><i class="glyphicon glyphicon-th-list"></i> ข้อมูลสมาชิก </a></li>
                </ul>

            </li><li class="">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-cog"></i> ตั้งต่าข้อมูล <b class="caret"></b></a>
                <ul class="dropdown-menu">
                    <li><a href="<?php echo site_url('/settings/manage_village')?>"><i class="glyphicon glyphicon-th-list"></i> จัดการข้อมูลหมู่บ้าน</a></li>
                </ul>
