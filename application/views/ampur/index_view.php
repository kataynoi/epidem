...
<ul class="nav nav-tabs">
    ...
    <li><a href="#tab_other" data-toggle="tab"><i class="glyphicon glyphicon-eye-close"></i> จากอำเภออื่น <span class="badge" id="spn_other">0</span></a></li>
</ul>
    ...
    <div class="tab-pane" id="tab_wait">
        ...
        <div class="navbar navbar-default">
            <form action="#" class="navbar-form">
                ...
                <div class="btn-group pull-right">
                    <a type="button" class="btn btn-success" data-name='btn_check_all' id="btn_check_all" title="เลือกทั้งหมด" data-rel="tooltip">
...
<script src="<?php echo base_url()?>assets/apps/js/ampur.js" charset="utf-8"></script>