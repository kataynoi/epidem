<nav role="navigation" class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <form action="#" class="navbar-form navbar-left">
            ...
            <input type="text" class="form-control" style="width: 350px;" value="<?php echo $address?>"
                disabled />

            <input type="hidden" id="txt_lat" value="<?php echo $lat?>" />
            <input type="hidden" id="txt_lng" value="<?php echo $lng?>" />
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li class="dropdown-header">
                        ...
                        <?php echo $this->session->userdata('amp_code')?>
                    </li>
...
<script src="<?php echo base_url()?>assets/apps/js/show_map.js" charset="utf-8"></script>
