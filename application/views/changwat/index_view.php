...
<div class="tab-content">
    ...
    <div class="tab-pane" id="tab_wait">
        <blockquote>
            <p>แสดงรายชื่อทั้งหมดที่ยังไม่ได้รับการยืนยันจากทางจังหวัด ซึ่งทั้งหมดได้รับการยืนยันจากทางอำเภอแล้ว</p>
        </blockquote>
        <br>
        <div class="navbar navbar-default">
            <form action="#" class="navbar-form">
        <div class="btn-group pull-right">
            <a type="button" class="btn btn-success" id="btn_check_all" data-name="btn_check_all" title="เลือกทั้งหมด" data-rel="tooltip">
...
<script src="<?php echo base_url()?>assets/apps/js/changwat.js" charset="utf-8"></script>