...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/apps/'); ?>/css/jquery.fileupload-ui.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/apps/'); ?>/css/style.css">
    <style>
        body {
