...
<ul class="nav nav-tabs">
    ...
    <li><a href="#tab_out_pt" data-toggle="tab"><i class="glyphicon glyphicon-link"></i> ผู้ป่วยในเขตที่ไปรักษาที่อื่น <span class="badge" id="spn_out_pt">0</span></a></li>
</ul>
...
-->
    ...
    <!--ผู้ป่วยที่รับบริการที่อื่น -->
    <div class="tab-pane" id="tab_out_pt">
        <br>
        <div class="alert alert-warning">ก่อนดูข้อมูลคนไข้นอกเขตได้ ท่านต้องกำหนดหมู่บ้านรับผิดชอบก่อนนะครับ
            <a href="<?php echo site_url('settings/set_village')?>">คลิกที่นี่</a></div>

        <div class="navbar navbar-default">
            <form class="nav navbar-form">
                <label>ชื่อโรค</label>
                <select id="sl_query_code506" style="width: 300px;" class="form-control">
                    <option value="">ทั้งหมด</option>
                    <?php
                ...
                <button type="button" class="btn btn-success" id="btn_search_disease_out">
                    <i class="glyphicon glyphicon-search"></i> ค้นหา
                </button>
            </form>
        </div>
        <table class="table table-striped" id="tbl_out_pt_list">
            <thead>
            <tr>
                <th></th>
                <th>หน่วยบริการที่รักษา</th>
                <th>ชื่อ - สกุล</th>
                <th>สัญชาติ</th>
                <th>ที่อยู่ขณะป่วย</th>
                <th>วันที่ป่วย</th>
        ...
        <ul class="pagination" id="out_pt_paging">x</ul>
    </div>
</div>
                    ...
                    <div class="tab-pane active" id="tab_patient_info">
                        ...
                        <form action="#" class="form-inline">
                            ...
                            <div class="row">
                                ...
                                <script>
                                    $('#xsl_occupation').select2({
                                        placeholder: 'พิมพ์ชื่อ หรือ รหัสอาชีพ',
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select id="sl_address_type" class="form-control">
                                    ...
                                    <option value="2" selected="selected" >นอกเขตเทศบาล</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="sl_service_place" class="form-control">
                                        <option value="">-*-</option>
                                        <option value="1">[1] รพ.ศูนย์</option>
                                        <option value="2">[2] รพ.ทั่วไป</option>
                                        <option value="3">[3] รพ.ชุมชน</option>
                                        <option value="4">[4] คลินิกราชการ</option>
                                        <option value="5">[5] สอ.</option>
                                        <option value="6">[6] รพ.ราชการในกทม</option>
                                        <option value="7">[7] คลินิก/รพ.เอกชน</option>
                                        <option value="8">[8] บ้าน</option></select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
...
<script src="<?php echo base_url()?>assets/apps/js/patient.index.js" charset="utf-8"></script>